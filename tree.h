...
//    ~tree()
// если оставить, то при удалении узла вылезает ошибка. можете попробовать разобраться:
// ошибка вылезает потому, что при удалении рута вызывается дефлотный конструктор и удаляет элемент, которого нет
// что это за элемент - хз, когда я тестил он всегда был в корне почему-то
//    {
//        delete root;
//    }
};
